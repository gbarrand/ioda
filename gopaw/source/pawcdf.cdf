*
* $Id: pawcdf.cdf,v 1.9 2009/07/02 15:01:00 barrand Exp $
*
* $Log: pawcdf.cdf,v $
* Revision 1.9  2009/07/02 15:01:00  barrand
* *** empty log message ***
*
* Revision 1.8  2009/07/02 13:57:49  barrand
* *** empty log message ***
*
* Revision 1.7  2009/06/07 17:06:13  barrand
* *** empty log message ***
*
* Revision 1.6  2009/05/31 08:40:21  barrand
* *** empty log message ***
*
* Revision 1.5  2007/05/10 09:28:46  barrand
* *** empty log message ***
*
* Revision 1.4  2007/05/10 09:21:22  barrand
* *** empty log message ***
*
* Revision 1.3  2007/05/10 08:11:32  barrand
* *** empty log message ***
*
* Revision 1.2  2007/04/28 09:16:52  barrand
* *** empty log message ***
*
* Revision 1.1.1.1  2006/09/13 14:04:20  barrand
*
*
* Revision 1.1.1.1  2005/12/18 12:37:57  barrand
*
*
* Revision 1.2  2004/08/29 12:33:06  barrand
* *** empty log message ***
*
* Revision 1.1.1.1  2004/08/03 14:28:17  barrand
*
*
* Revision 1.4  2004/08/03 12:09:58  barrand
* *** empty log message ***
*
* Revision 1.3  2004/08/02 07:16:40  barrand
* *** empty log message ***
*
* Revision 1.2  2003/09/10 07:52:06  barrand
* *** empty log message ***
*
...
-SURF5  gopaw : Draw 2-Dim with colored proportional height.
...
-LEGO3  gopaw : Draw 2-Dim with colored proportional boxes.
...
-PROFS  Fill a Profile histogram (spread option).
-PROFI  Fill a Profile histogram (integer spread option).
-BOX    gopaw : Draw 2-Dim with proportional boxes.
-COL    gopaw : Draw 2-Dim with a colour table.
-SURF   gopaw : Draw as a surface plot (angles are set via the command angle).
-LEGO   gopaw : Draw as a lego plot (angles are set via the command angle).
-CONT   gopaw : Draw 2-Dim as a contour plot (15 levels).
-TEXT   gopaw : Draw 2-Dim as a table.
IDH     'Identifier of histogram to fill' I D=1000000
>Keyword
...
LMIN 'Lut min'   R D=0
LMAX 'Lut max'   R D=1
CMAP 'File name' C D='colrj32'
X 'X coordinate' R D=0
Y 'Y coordinate' R D=0
WIDTH 'not used for the moment.' R D=1
HEIGHT 'height in Y axis coordinate.' R D=1
THETA 'angle in degrees' R D=0
PHI 'angle in degrees' R D=0
>Keyword
fits image hdu lut
>Guidance
Draw an image taken from a fits file.
.
CMAP could be:
  col16
  colrj32
  ...
  midas_idl15
.
(THETA,PHI) usual spherical angles. THETA around y axis, and then PHI around z.
.
Example:
  * Draw an image taken in a fits file.
  SET * ; OPT *  | Reset the defaults
  SET XTIC 0.0001
  SET YVAL 100.
  SET YTIC 0.0001
  ...
  IMAGE_HDU 1 0 0 200 colbr32 1 1 1 1.5 0 0
  close 1
>Action PAGPRI
...
-S  gopaw : Put all legend in one legend box.
>Keyword
legend
>Guidance
...
CHOPT 'Options'                 C D=' '
-          gopaw : type taken from file suffix. If .ps or .eps, gl2ps is used to produce the file.
-INZB_PS   gopaw : inlib::sg::zbuffer in PostScript.
-INZB_JPEG gopaw : JPEG
-INZB_PNG  gopaw : PNG
-GLFB_JPEG gopaw : GL frame buffer in jpeg
-GLFB_PNG  gopaw : GL frame buffer in png
-GL2PS_PS  gopaw : Vector PostScript by using gl2ps.
-GL2PS_EPS gopaw : Vector Encapsulated PostScript by using gl2ps.
-GL2PS_PDF gopaw : Vector PDF by using gl2ps.
-GL2PS_SVG gopaw : Vector SVG by using gl2ps.
-GL2PS_TEX gopaw : TEX by using gl2ps.
-GL2PS_PGF gopaw : PGF by using gl2ps.
>Keyword
...
-S Superimpose plot on top of existing picture.
-+ Add contents of ID to last plotted histogram.
-E gopaw : Draw error bars and current marker.
-B Select Bar chart format.
-L Connect channels contents by a line.
-P Draw the current polymarker at each channel.
-* Draw a * at each channel.
