...
/* initialize an array of random numbers */
    ...
    */  
	...
	fits_rand_value[ii] = (float)(seed / m); /*G.Barrand : WIN32 : cast.*/
    }
...
*/
{
    ...
    /*G.Barrand float fminval, fmaxval, delta, zeropt, *fdata, *ftemp;*/
    ...
    /* =========================================================================== */
	    ...
	    */
	    ...
	    if (hcompscale > 0.) {
	       ...
	       hcompscale = (float) (hcompscale * noise3); /*G.Barrand : cast*/
