...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  ...
  case SbPrimitiveLineLoop:
    drawLines(aPointn,
              aXs,aYs,
              aAtb.fRed,aAtb.fGreen,aAtb.fBlue,
              aAtb.fLinePattern,aAtb.fLineWidth);
    break;
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  ...
  putCapInStream(1);
  putLinePatternInStream(aPattern);
  putStrokeInStream();
}
//////////////////////////////////////////////////////////////////////////////
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  ...
  if( (aString==NULL) || (*aString=='\0') ) {
    if( (fFileName==NULL) || (*fFileName=='\0') ) { // Take default name :
      ...
      SbSTRDEL(fFileName);
      fFileName = SbSTRDUP(METAFILE_DEFAULT);
    } else {
...
//////////////////////////////////////////////////////////////////////////////
void SbPainterPS::putLinePatternInStream(
 SbLinePattern aStyle
)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  switch(aStyle) {
  case SbLinePattern_solid:putInStreamF("ss ") ;break;
  case SbLinePattern_dashed:putInStreamF("sd ") ;break;
  case SbLinePattern_dotted:putInStreamF("so ") ;break;
  case SbLinePattern_dash_dotted:putInStreamF("sdo ");break;
  }
}
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
