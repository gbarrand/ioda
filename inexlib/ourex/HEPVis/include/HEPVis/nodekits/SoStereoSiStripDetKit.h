...
/*                                                                           */
/*---------------------------------------------------------------------------*/
#ifndef HEPVis_SoStereoSiStripDetKit_h
#define HEPVis_SoStereoSiStripDetKit_h
...
class SoSFNode;
class SoTransform;
class SoStereoSiStripDetKit:public SoBaseKit {

  // The following is required:
  SO_KIT_HEADER(SoStereoSiStripDetKit);
  ////////////////////////////////////////////
public:
  SoSFFloat stereoAngle;
...
private:
  ...
  SO_KIT_CATALOG_ENTRY_HEADER(topSeparator);
    ...
    SO_KIT_CATALOG_ENTRY_HEADER(stripsSeparator);
      ...
      SO_KIT_CATALOG_ENTRY_HEADER(stretch);
      SO_KIT_CATALOG_ENTRY_HEADER(rot);
      SO_KIT_CATALOG_ENTRY_HEADER(zStripsAppearance);
      SO_KIT_CATALOG_ENTRY_HEADER(zStrips);
