...
class SoDblSiStripWedgeDetKit:public SoBaseKit {

  // The following is required:
  SO_KIT_HEADER(SoDblSiStripWedgeDetKit);
  ////////////////////////////////////////////
public:
...
protected:
  // Destructor.  Required.
  virtual ~SoDblSiStripWedgeDetKit();
