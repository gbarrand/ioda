...
public:
  ...
  //          Then HEPVis::SbRotation() don't do the same than
  ...
  virtual ~SbRotation(){}
public:
  SbRotation(const SbRotation& aFrom):quat(aFrom.quat){}

  SbRotation& operator=(const SbRotation& aFrom){
    quat = aFrom.quat;
    return *this;
  }

  //SbRotation& SbRotation::operator*=(const double s){
  //  quat *= s;
  //  return *this;
  //}
