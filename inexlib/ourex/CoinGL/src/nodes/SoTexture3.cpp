...
SoTexture3::filenameSensorCB(void * data, SoSensor *)
{
  ...
  //G.Barrand : g++ 4.3.2 : have parenthesis :
//if (thisp->filenames.getNum()<0 ||      //G.Barrand
//    thisp->filenames[0].getLength() &&  //G.Barrand
  if ( (thisp->filenames.getNum()<0 ||        //GB
        thisp->filenames[0].getLength()) &&   //GB : is it ok ?
      !thisp->loadFilenames()) {
