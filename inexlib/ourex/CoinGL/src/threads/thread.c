...
static int internal_init(cc_thread * thread){return 0;}
static int internal_clean(cc_thread * thread_struct){return 0;}
static int internal_join(cc_thread * thread,void ** retvalptr){return 0;}
void Sleep(int x){}
unsigned long cc_thread_id(void){return 0;}
#endif
