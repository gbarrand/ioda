...
/*!
  ...
  \sa SbBox2d, SbBox2f, SbBox2i32, SbBox2s, SbBox3d, SbBox3i32, SbBox3s, SbXfBox3d, SbXfBox3f
*/
...
/*!
  ...
  coordinates to floating point precision values
...
SbBox3f::setBounds(const SbBox3d & box)
{
  if (box.isEmpty()) {
    ...
    this->min.setValue(box.getMin());
    this->max.setValue(box.getMax());
  }
  return *this;
}
