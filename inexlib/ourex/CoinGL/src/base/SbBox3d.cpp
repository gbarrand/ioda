...
/*!
  ...
  \sa SbBox2d, SbBox2f, SbBox2i32, SbBox2s, SbBox3f, SbBox3i32, SbBox3s, SbXfBox3d, SbXfBox3f
*/
...
/*!
  \fn explicit SbBox3d::SbBox3d(const SbBox3f & box)

  Constructs a box with coordinates from \a box, converting the
  coordinates to floating point double precision values

  \since Coin-2.5
*/

/*!
  \fn explicit SbBox3d::SbBox3d(const SbBox3s & box) 
...
/*!
  \fn explicit SbBox3d::SbBox3d(const SbBox3i32 & box) 
