...
/*!
  ...
  \sa SbBox2d, SbBox2f, SbBox2i32, SbBox2s, SbBox3d, SbBox3f, SbBox3i32, SbXfBox3d, SbXfBox3f
  \since Coin 2.0
  \since TGS Inventor ?.?
*/
...
/*!
  ...
  Check if the box has "positive" volume, i.e. the lower left corner
  is actually lower and more left than the maximum point. If so,
  return the volume.
*/

/*!
  \fn SbVec3f SbBox3s::getCenter(void) const
