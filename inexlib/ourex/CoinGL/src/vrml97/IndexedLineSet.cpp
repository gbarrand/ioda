...
class SoVRMLIndexedLineSetP {
 public:
  SoVRMLIndexedLineSetP() : vaindexer(NULL), nodeid(0) { }
...
#define PRIVATE(obj) ((SoVRMLIndexedLineSetP*) PointerMap::get(this))
