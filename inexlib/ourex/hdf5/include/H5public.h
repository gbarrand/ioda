...
/*G.Barrand : #   define H5_PRINTF_HADDR_FMT  "%"H5_PRINTF_LL_WIDTH"u" */
#   define H5_PRINTF_HADDR_FMT  "%" H5_PRINTF_LL_WIDTH "u"  /*G.Barrand : c++11 : add spaces. */
