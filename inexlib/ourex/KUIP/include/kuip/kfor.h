...
/*
 * $Id: kfor.h,v 1.1.1.1 2013/07/18 11:08:49 barrand Exp $
 *
 * $Log: kfor.h,v $
 * Revision 1.1.1.1  2013/07/18 11:08:49  barrand
 *
 *
 * Revision 1.4  2006/09/09 18:49:48  barrand
 * *** empty log message ***
 *
 * Revision 1.3  2005/06/08 07:55:10  barrand
 * *** empty log message ***
 *
 * Revision 1.2  2004/12/25 13:50:31  barrand
 * *** empty log message ***
 *
...
#else
#define F77_IFUN_x(i0,name,x1) i0 = (*name)(x1,kjmpaddr.action_data)
#endif
...
#else
#define F77_IFUN_xx(i0,name,x1,x2) i0 = (*name)(x1,x2,kjmpaddr.action_data)
#endif
...
/*GB #define  Kusigm           F77_NAME(kusigm,KUSIGM)*/
