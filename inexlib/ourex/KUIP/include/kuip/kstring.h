/*
 * $Id: kstring.h,v 1.1.1.1 2013/07/18 11:08:49 barrand Exp $
 *
 * $Log: kstring.h,v $
 * Revision 1.1.1.1  2013/07/18 11:08:49  barrand
 *
 *
 * Revision 1.3  1999/11/30 13:42:13  barrand
 * *** empty log message ***
 *
 * Revision 1.2  1999/11/08  11:50:50  barrand
 * *** empty log message ***
 *
...
#define ku_strcasecmp strcasecmp   
#define ku_strncasecmp strncasecmp   
#else  
extern int   ku_strcasecmp( const char* str1, const char* str2 );
extern int   ku_strncasecmp( const char* str1, const char* str2, size_t n );
#endif

extern char* strrstr( const char* str1, const char* str2 );

extern char* kuip_strdup( const char* str );
...
extern char* kuip_strndup( const char* buf, size_t n );
