...
public class Main extends NativeActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    //System.err.println("ioda : debug : Main::onCreate : 015");
    ...
    if(action.compareTo(Intent.ACTION_VIEW)==0) {
      ...
      if(scheme.compareTo(ContentResolver.SCHEME_FILE)==0) {
        ...
        //Log.v("ioda::Main::onCreate","File intent : "+
        //      action+" : "+intent.getDataString()+" : "+intent.getType()+" : "+name);
        String document_path = "/sdcard/Android/data/fr.in2p3.lal.ioda/DOCUMENT";
        ...
        //Log.v("ioda::Main::onCreate","Content intent : "+
        //      action+" : "+intent.getDataString()+" : "+intent.getType()+" : "+name);
        String document_path = "/sdcard/Android/data/fr.in2p3.lal.ioda/DOCUMENT";
        uri_to_file(uri,document_path); 
...
/*
        ...
        Log.v("ioda::Main::onCreate","http intent : "+
              action+" : "+intent.getDataString()+" : "+intent.getType());
        DownloadManager.Request r = new DownloadManager.Request(uri);
        r.setDestinationInExternalPublicDir("/sdcard/Android/data/fr.in2p3.lal.ioda","DOCUMENT");
...
*/
  ...
  private void load_resources() {
    ...
    // app_dir is : /data/data/fr.in2p3.lal.ioda/files
  ...
  private void uri_to_file(Uri a_uri,String a_file) {
    try {
      ...
      Log.e("ioda::uri_to_file "," exception: " + e.getMessage());
    }
  }
